package xyz.wagyourtail.oldminimap.client.gui.renderer;
...
import xyz.wagyourtail.oldminimap.client.gui.AbstractMapGui;
...
import xyz.wagyourtail.oldminimap.client.gui.image.BlockLightImageStrategy;
import xyz.wagyourtail.oldminimap.client.gui.image.VanillaMapImageStrategy;
import xyz.wagyourtail.oldminimap.client.gui.renderer.overlay.AbstractMapOverlayRenderer;
...
public abstract class AbstractMapRenderer {
    ...
    protected ChunkData getChunk(int chunkX, int chunkZ) {
        try {
            MapRegion region = parent.parent.currentLevel.getRegion(new MapLevel.Pos(chunkX >> 5, chunkZ >> 5));
