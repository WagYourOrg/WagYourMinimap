...
import xyz.wagyourtail.minimap.api.config.fullscreenoverlays.PlayerIconOptions;
import xyz.wagyourtail.minimap.api.config.fullscreenoverlays.WaypointOverlayOptions;
