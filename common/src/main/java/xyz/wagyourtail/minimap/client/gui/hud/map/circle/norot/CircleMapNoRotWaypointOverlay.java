package xyz.wagyourtail.minimap.client.gui.hud.map.circle.norot;
...
public class CircleMapNoRotWaypointOverlay extends AbstractMapOverlayRenderer {
    ...
    public CircleMapNoRotWaypointOverlay(AbstractMinimapRenderer parent) {
        super(parent);
    }
