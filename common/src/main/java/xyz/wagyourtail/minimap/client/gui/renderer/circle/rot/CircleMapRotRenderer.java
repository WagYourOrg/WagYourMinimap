package xyz.wagyourtail.minimap.client.gui.renderer.circle.rot;
...
public class CircleMapRotRenderer extends AbstractMinimapRenderer {

    public CircleMapRotRenderer() {
